  ...
  return (
    <div className="w-full flex justify-center">
      <div className="flex flex-col w-1/2 gap-5">
        ...
        <div className="bg-gray-700 bg-opacity-30  drop-shadow-md grid grid-cols-6 rounded-lg gap-7 py-3 px-1 mt-5">
        ...
        <div className="bg-gray-700 bg-opacity-30  drop-shadow-md grid grid-cols-6 rounded-lg gap-7 py-3 px-1 mb-5">
          <div className="text-gray-400 place-self-start justify-self-end col-span-2">
            Abril 2023 - Presente
          </div>
          <div className="col-span-4">
