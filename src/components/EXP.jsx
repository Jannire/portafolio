...
function EXP() {
  ...
  return (
    <div>
      <p className="text-center text-2xl mt-5 mb-3">
        Experiencia
      </p>
      <div className=" flex justify-center">
        <div className="flex flex-col w-1/2 gap-5">
          ...
          <div className="relative group mt-5 mb-7">
            <div className="absolute inset-0 rounded-lg blur bg-bluey bg-gradient-to-r from-bluey to-pinky opacity-75 group-hover:opacity-100 transition duration-200 animate-tilt"></div>
